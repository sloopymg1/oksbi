...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/nitropack/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/okissibiri/MYAPPS/MUSIC%20PACKAGE/oksbi/services/web/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/okissibiri/MYAPPS/MUSIC PACKAGE/oksbi/services/web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/okissibiri/MYAPPS/MUSIC PACKAGE/oksbi/services/web","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/okissibiri/MYAPPS/MUSIC PACKAGE/oksbi/services/web/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/okissibiri/MYAPPS/MUSIC PACKAGE/oksbi/services/web/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/okissibiri/MYAPPS/MUSIC PACKAGE/oksbi/services/web/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/okissibiri/MYAPPS/MUSIC PACKAGE/oksbi/services/web/.data/kv"}));
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"theme-color","content":"#17211f"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&family=Fraunces:opsz,wght@9..144,600;9..144,700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"OKSBI Workspace"};
...
const rootDir = "/Users/okissibiri/MYAPPS/MUSIC PACKAGE/oksbi/services/web";
...
const _r8XnDT = eventHandler((event) => {
...
const _lazy_uiLv4Y = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _r8XnDT, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_uiLv4Y, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uiLv4Y, lazy: true, middleware: false, method: undefined }
];
