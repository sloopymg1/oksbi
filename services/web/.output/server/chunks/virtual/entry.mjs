...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		name: "catalog",
		path: "/catalog",
		component: () => import('../build/catalog-BVHrLN1O.mjs')
	},
	{
		name: "create-account",
		path: "/create-account",
		component: () => import('../build/create-account-Vmd_kRn3.mjs')
	},
	{
		name: "login",
		path: "/login",
		component: () => import('../build/login-paqaZiWl.mjs')
	},
	{
		name: "payouts",
		path: "/payouts",
		component: () => import('../build/payouts-p1dtDePj.mjs')
	},
	{
		name: "rights",
		path: "/rights",
		component: () => import('../build/rights-CEnTZRgm.mjs')
	},
	{
		name: "royalties",
		path: "/royalties",
		component: () => import('../build/royalties-B7ntqLw3.mjs')
	},
	{
		name: "support",
		path: "/support",
		component: () => import('../build/support-DmsjUeNs.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-CGIWItVr.mjs')
	}
];
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import('../build/default-CCR-7ltU.mjs').then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-CU5pECk6.mjs'));
...
export { _plugin_vue_export_helper_default as _, useRoute$1 as a, useNuxtApp as b, useHead$1 as c, useRuntimeConfig as d, encodeRoutePath as e, nuxtLinkDefaults as f, entry as g, navigateTo as n, resolveRouteObject as r, stateDiagnostics as s, useRouter as u };
